 ...
 */
class getUniversRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UniversRepository' shared autowired service.
     *
     * @return \App\Repository\UniversRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UniversRepository.php';

        return $container->privates['App\\Repository\\UniversRepository'] = new \App\Repository\UniversRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
