...
class get_Doctrine_SystemCachePool_TaggableService extends App_KernelProdContainer
{
    ...
    {
        return $container->privates['.doctrine.system_cache_pool.taggable'] = new \Symfony\Component\Cache\Adapter\TagAwareAdapter(($container->privates['doctrine.system_cache_pool'] ?? $container->getDoctrine_SystemCachePoolService()));
    }
}
