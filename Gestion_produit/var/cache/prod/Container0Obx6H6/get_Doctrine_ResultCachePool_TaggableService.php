...
class get_Doctrine_ResultCachePool_TaggableService extends App_KernelProdContainer
{
    ...
    {
        return $container->privates['.doctrine.result_cache_pool.taggable'] = new \Symfony\Component\Cache\Adapter\TagAwareAdapter(($container->privates['doctrine.result_cache_pool'] ?? $container->getDoctrine_ResultCachePoolService()));
    }
}
